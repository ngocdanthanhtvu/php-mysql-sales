...
CREATE TABLE product_images (
    ...
    CONSTRAINT uq_product_image
        UNIQUE (ProductID, ImageFile),

    CONSTRAINT chk_product_image_sort
        CHECK (SortOrder >= 0),
...
CREATE TABLE orderdetail (
    ...
    CONSTRAINT chk_orderdetail_unitprice
        CHECK (UnitPrice >= 0),
